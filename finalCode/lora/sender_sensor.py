...
class LoRaSensorSender:
    ...
    Can read from BMP280, MPU6050, GY511, GPSM6N, sikap mode, or all and transmit via LoRa.
    
    Attributes:
        sensors (str): Which sensors to use - 'bmp280', 'mpu6050', 'gy511', 'gpsm6n', 'sikap', or 'all'
    ...
    VALID_SENSORS = ('bmp280', 'mpu6050', 'gy511', 'gpsm6n', 'sikap', 'all')
    
    def __init__(self, sensors='all', verbose=False):
        """
        Initialize the LoRa sensor sender.
        
        Args:
            sensors: Which sensors to use - 'bmp280', 'mpu6050', 'gy511', 'gpsm6n', 'sikap', or 'all'
    ...
    def format_pesan(self, data, counter):
        """
    ...
    def kirim_data(self, counter):
        ...
        """
        data = self.baca_data()
        pesan = self.format_pesan(data, counter)
        sukses = self.lora.kirim(pesan)
        return sukses, pesan
...
Examples:
    ...
    parser.add_argument(
        '--sensor',
        choices=['bmp280', 'mpu6050', 'gy511', 'gpsm6n', 'sikap', 'all'],
        default='all',
