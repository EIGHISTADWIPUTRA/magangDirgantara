...
def create_surf_detector():
    # SURF tersedia pada opencv-contrib (xfeatures2d).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="SURF + FLANN real-time matcher")
    ...
    if detector is None:
        print("Error: SURF tidak tersedia. Install opencv-contrib-python terlebih dahulu.")
        return 1

    # FLANN untuk descriptor float (SURF) menggunakan KDTree.
    ...
    while True:
        ...
        cv2.imshow("FLANN Matching - SURF", result_img)
