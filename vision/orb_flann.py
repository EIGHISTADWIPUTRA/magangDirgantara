...
def main() -> int:
    parser = argparse.ArgumentParser(description="ORB + FLANN real-time matcher")
    ...
    # FLANN untuk descriptor binary (ORB) menggunakan LSH.
    index_params = dict(
        algorithm=6,
        table_number=6,
        key_size=12,
    ...
    while True:
        ...
        cv2.imshow("FLANN Matching - ORB", result_img)
